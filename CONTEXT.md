...
- Last updated: 2026-05-12 10:24:53 +09:00
- Branch: `wip/phase2-front-back`
- Commit: `6f73f51`
...
- `M  ai/tools/podcast_catalog.py`
- `A  backend/.env.example`
- `M  backend/app/routers/content.py`
- `M  backend/app/routers/user.py`
- `M  docker-compose.yml`
- `A  docs/ARCHITECTURE.md`
- `A  docs/ARCHITECTURE_AI_PIPELINE.md`
- `A  docs/CLASS_DIAGRAM.md`
- `A  docs/REPORT_SECTION3.md`
- `M  frontend/Dockerfile`
- `A  frontend/components/chat-markdown.tsx`
